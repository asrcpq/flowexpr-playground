/* @ts-self-types="./flowexpr_playground.d.ts" */
 ...
 * @returns {string}
 */
export function eval_expr(expr, env_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        const ret = wasm.eval_expr(ptr0, len0, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./flowexpr_playground_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('flowexpr_playground_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
